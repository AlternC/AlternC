<?php
/*
 $Id: adm_list2.php,v 1.5 2006/01/24 05:03:30 joe Exp $
 ----------------------------------------------------------------------
...
<tr><th colspan="4">&nbsp;</th><th><?php __("Username"); ?></th><th><?php echo _("Surname")." "._("First Name")."<br />("._("Email address").")"; ?></th><th><?php __("Account type") ?></th><th><?php __("Last login"); ?></th><th><?php __("Last fail"); ?></th><th><?php __("Last ip"); ?></th></tr>
<?php
reset($r);
$col=1;
